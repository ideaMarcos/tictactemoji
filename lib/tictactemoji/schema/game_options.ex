defmodule Tictactemoji.Schema.GameOptions do
  ...
  def changeset(%__MODULE__{} = game, attrs) do
    ...
    |> validate_number(:grid_size, greater_than_or_equal_to: 3, less_than_or_equal_to: 5)
    |> validate_number(:num_players, greater_than_or_equal_to: 1, less_than_or_equal_to: 4)
  end
